...
<head>
    <title><b><?php getValueFromJson('title'); ?></title>
...
<body>
    ...
    <main>
        ...
        <section>
            ...
            <a><b><?php getValueFromJson('identity.name') ?></b>AIMA DEVELOPPEMENT</a>
            <a><b><?php getValueFromJson('identity.juridicalForm') ?></b>SA</a>
            <a><b><?php getValueFromJson('identity.capital') ?></b>363 704€</a>
        </section>
        <section>
            <h2><?php getValueFromJson('coordonates.title') ?></h2>
            <a><b><?php getValueFromJson('coordonates.address') ?></b>
                AIMA DEVELOPPEMENT,<br>
                227 avenue de la Lanterne,<br>
                Au Centre Antoine Lacassagne,<br>
                06200 Nice</a>
            <a><b><?php getValueFromJson('coordonates.email') ?></b>contact@aima.fr</a>
            <a><b><?php getValueFromJson('coordonates.phone') ?></b>+33 04 93 83 58 41</a>
        </section>
        <section>
        ...
        <section>
            ...
            <a><b><?php getValueFromJson('commercialActivity.RCS') ?></b>480 635 630</a>
            <a><b><?php getValueFromJson('commercialActivity.TVA') ?></b>FR59 480635630</a>
        </section>
    </main>
    <footer>
